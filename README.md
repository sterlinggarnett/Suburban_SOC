...
| M18 | ECS Pipeline & Field-Mapping Integrity | 🚧 In progress ([milestone](https://github.com/voltron-1/Suburban_SOC/milestone/23), 4/13 issues closed) — Logstash rename/copy drift vs. what suburban-soc-ecs.yml claims, dashboard fields that don't exist on the real mapping, truncation ceilings, index-template rollover |
