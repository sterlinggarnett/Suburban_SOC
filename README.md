...
| M22 | Compliance & Documentation Accuracy | ⏳ 4/7 closed ([milestone](https://github.com/voltron-1/Suburban_SOC/milestone/27)) — analyst-facing rule text leaking ES-analyzer detail, an SLO coverage-count off-by-one, and a Sigma tag-extraction gap all closed; 1 open (#296, unclaimed), 2 blocked on an external contributor's in-flight PR (#439/#380) |
