...
| M17 | Detection Rule Coverage & Correctness | ⏳ 18/34 closed ([milestone](https://github.com/voltron-1/Suburban_SOC/milestone/22)) — a project-board audit found 7 more review-follow-up issues filed without a milestone and retroactively assigned them here after the original "6/8" close; 12 addressed via open/unmerged PRs #494–#502 (2026-08-29), 4 permanently not actionable (#283, #333 externally blocked/speculative; #415, #421 need a live Docker/Zeek stack this environment doesn't have) |
