...
The generic actions below are superseded by the per-rule sections; they remain as the workflow-phase summary.

### Identification
Phases 1–3 of the standard workflow: validate the alert against the rule's section, extract the listed fields, enrich per the section's criteria.

### Containment
Phase 4 of the standard workflow: apply the section's containment decision flow — automated tier action on confirmation, analyst triage path otherwise.
