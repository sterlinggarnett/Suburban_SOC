...
| M18 | ECS Pipeline & Field-Mapping Integrity | ⏸️ 15/18 closed (updated 2026-09-03, [milestone](https://github.com/voltron-1/Suburban_SOC/milestone/23)) — #403/#390/#396 shipped and closed 2026-09-03 (PRs #530/#531/#532); #389 got an interim Logstash visibility tag (PR #529, `pipeline.dns_answer_truncated_by_zeek`) but stays open for the real Zeek-side fix, which needs a live Zeek/Docker environment; #326 (externally blocked, needs real Windows/PowerShell telemetry accumulating over time) and #405 (needs a live-pipeline perf benchmark or a dedicated Sigma-corpus field-resolution design effort, assessed and commented, not attempted) remain, both genuinely not actionable in this sandbox |
