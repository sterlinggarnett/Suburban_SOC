...
| M18 | ECS Pipeline & Field-Mapping Integrity | ⏸️ 16/18 closed (updated 2026-09-03, [milestone](https://github.com/voltron-1/Suburban_SOC/milestone/23)) — #389/#403/#390/#396 fixed and closed this session; #326 (externally blocked, needs real Windows/PowerShell telemetry accumulating over time) and #405 (needs a live-pipeline perf benchmark or a dedicated Sigma-corpus field-resolution design effort, assessed and commented, not attempted) remain, both genuinely not actionable in this sandbox |
